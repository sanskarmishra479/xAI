...
export const WindowTab = () => {
    return(
        <div className="relative h-70 md:h-110 w-90 flex items-center justify-center">
        <div className="absolute top-10 h-full w-full border border-white/20 group-hover:border-white/40 overflow-hidden cursor-pointer group-hover:rotate-x-15 group-hover:rotate-y-35 transition-all duration-150">
